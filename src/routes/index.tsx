          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <article className="relative flex flex-col rounded-md bg-navy-deep p-8 text-cream shadow-[0_30px_60px_-30px_oklch(0.16_0.06_262_/_0.6)]">
              ...
              <div className="mt-8 space-y-5">
                <div className="rounded-md border border-electric/40 bg-electric/10 p-5">
                  ...
                  <p className="mt-2 text-sm text-cream/80">
                    With code <span className="font-display tracking-wider text-cream">Join ISOCNV</span> — members join for $10.
                  </p>
                </div>
              ...
              <p className="mt-6 text-sm text-cream/70">
                Join ISOCNV lowest rate now — $10
                or register for $249 list price. Use the ISOCNV member code at checkout to drop
                it all the way to $10.
              </p>
